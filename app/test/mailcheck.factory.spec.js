describe("mailcheck factory", function () {
  ...
  describe("run()", function () {
    ...
    it("should return defaultSecondLevelDomains array", function () {
      expect(mailcheckFactory.defaultSecondLevelDomains).toEqual(
        defaultSecondLevelDomains
      );
    });
    it("should return defaultTopLevelDomains array", function () {
      expect(mailcheckFactory.defaultTopLevelDomains).toEqual(
        defaultTopLevelDomains
      );
    });
    it("should return gangadharjannu@gmail.com", function () {
      expect(mailcheckFactory.run({ email: email }).full).toEqual(
        "gangadharjannu@gmail.com"
      );
    });
    ...
    it("should return gangadharjannu@github.me", function () {
      ...
      expect(mailcheckFactory.run(options).full).toEqual(
        "gangadharjannu@github.me"
      );
    });
  });
});
