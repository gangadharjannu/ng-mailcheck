(function () {
    ...
    var Mailcheck = {
      ...
      run: function (opts) {
        ...
        opts.distanceFunction =
          opts.distanceFunction || Mailcheck.sift4Distance;
      ...
      suggest: function (
        ...
        var closestSecondLevelDomain = this.findClosestDomain(
      ...
      splitEmail: function (email) {
        email =
          email !== null ? email.replace(/^\s*/, "").replace(/\s*$/, "") : null; // trim() not exist in old IE!
  ...
  angular.module("ngMailcheck").factory("mailcheckFactory", mailcheckFactory);
})();
