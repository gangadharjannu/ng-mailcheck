(function () {
    ...
    var DDO = {
      ...
      link: function (scope, element, attrs, ctrls) {
        ...
        if (
          ...
          !restrictedTypes.test(attrs.type)
        ) {
          throw new Error(
            "mailcheck element is limited to text, email, search input types only"
          );
        }
        ...
        var ngModelCtrl = ctrls[0],
          ...
          result = null,
          templateStr =
            MC.options.templateStr ||
            '<p ng-show="MC.suggestion.domain">Did you mean <b ng-click="MC.correctMe(MC.suggestion.full)"><i ng-bind="MC.suggestion.full"></i></b>?</p>',
          defaultOptions = {
        ...
        if (!options.replaceOptions) {
          ...
          options = angular.extend(
            {},
            defaultOptions,
            concatOptions(MC.options, mailcheckDefaultOptions)
          );
        }
        /* Implementation */
  ...
  angular.module("ngMailcheck", []).directive("mailcheck", mailcheck);
})();
